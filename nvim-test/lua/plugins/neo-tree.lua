return {
	...
	config = function(_, opts)
		...
		-- Ensure proper icon handling - gracefully handle icon loading issues
		local function setup_icons()
			local ok, icons = pcall(require, "nvim-web-devicons")
			if not ok then
				-- Fallback to basic icons if nvim-web-devicons fails
				vim.notify("Neo-tree: nvim-web-devicons not available, using fallback icons", vim.log.levels.WARN)
			end
		end
