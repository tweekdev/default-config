-- DISABLED: This file is completely disabled
-- LazyVim handles all completion via coding.lua
return {}
        ...
        mapping = {
          ...
          ["<Tab>"] = cmp.mapping(function(fallback)
            if cmp.visible() then
              ...
              if current_entry and (current_entry.source.name == "copilot" or current_entry.source.name == "codeium") then
